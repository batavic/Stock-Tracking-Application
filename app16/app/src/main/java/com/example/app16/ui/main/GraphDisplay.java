...
public class GraphDisplay extends Drawable implements Drawable.Callback, GraphDisplayInterface
{ private String graphKind = "line";
  ...
  public GraphDisplay getInstance() {
      return this;
}
  ...
  { xpoints = new ArrayList<Double>();
    ...
    public void addY(Double yp)
    { ypoints.add(yp); }

    public void addZ(Double zp)
    { zpoints.add(zp); }

    public void addXLabel(String xl)
    { xlabels.add(xl); }

    public void removeY(int index){
        ypoints.remove(index);
    }

    public void removeZ(int index){
        zpoints.remove(index);
    }

    public void removeXLabel(int index){
    ...
    public void setSize(int size) { LabelSize = size; }

    public boolean full(){ return xlabels.size() == LabelSize; }

    public boolean symbols_number() {return ypoints.size() > xlabels.size(); }

    public int Ysize() {return ypoints.size();}

    public int Zsize() {return ypoints.size();}

    public int Xsize() {return ypoints.size();}
...
interface GraphDisplayInterface {
    void setSize(int size);
    boolean full();
    boolean symbols_number();
    int Ysize();
    double getY(int index);
    void addY(Double yp);
    void addZ(Double zp);
    void addXLabel(String xl);
    void removeY(int index);
    GraphDisplay getInstance();
    void setPoints(ArrayList<Double> xp, ArrayList<Double> yp);
}
